...
GnssSubscriber::GnssSubscriber()
  ...
  mGnssSynchronizer->registerCallback(
      std::bind(&GnssSubscriber::gnssSyncCallback, this, std::placeholders::_1, std::placeholders::_2));
}

void GnssSubscriber::gnssSyncCallback(const sensor_msgs::msg::NavSatFix::ConstSharedPtr& gnssPosition,
