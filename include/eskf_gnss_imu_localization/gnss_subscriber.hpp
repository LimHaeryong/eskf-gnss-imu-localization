...
{
public:
    using SyncPolicy = message_filters::sync_policies::ApproximateTime<sensor_msgs::msg::NavSatFix, geometry_msgs::msg::TwistStamped>;

    GnssSubscriber();
    ~GnssSubscriber() {}

private:
    void gnssSyncCallback(const sensor_msgs::msg::NavSatFix::ConstSharedPtr& gnssPosition, const geometry_msgs::msg::TwistStamped::ConstSharedPtr& gnssVelocity) const;
